...
function History() {
  ...
  const realSessions = getMonitoringSessions().map(
    (session) => {
      ...
      return {
        ...
        note:
          "Recorded from your latest monitoring session.",
      };
    }
  );
        ...
        >
          ...
          >
            ...
            <div className="history-modal__footer">
              ...
              <span>
                This session is stored locally and is ready for backend integration.
              </span>
            </div>
          </div>
        </div>
