...
const sessions = sessionHistory.map((session) => ({
  ...
  emoji:
    session.dominantEmotion === "Happy"
      ? "😊"
      : session.dominantEmotion === "Calm"
        ? "😌"
        : session.dominantEmotion === "Neutral"
          ? "😐"
          : session.dominantEmotion === "Anxious"
            ? "😟"
            : session.dominantEmotion === "Stressed"
              ? "😣"
              : session.dominantEmotion === "Sad"
                ? "😔"
                : "🙂",

  score: session.wellbeingScore,
  ...
  note:
    session.note ||
    "Emotional signals recorded during this monitoring session.",
}));
      ...
      <section className="history-main">
        ...
        >
          ...
          <div>
            ...
            <h3>
              Calm has been your most
              frequent emotional state.
            </h3>

            <p>
              Across your recent sessions,
              calm signals appeared more often
              than any other tracked emotion.
              Your average well-being score has
